    ...
    >
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Real-time blockchain verification and security monitoring
        </p>
      </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-mono font-bold text-2xl text-primary-600">
              ...
              <div>
                ...
                <p className="font-semibold">
                  {new Date(stats.latestBlock.timestamp).toLocaleString()}
                </p>
              </div>
            </div>
                ...
                <div className="bg-white p-4 rounded border border-gray-200">
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <p className="font-semibold">
                        {stats.latestBlock.data.touristId || "Genesis Block"}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-600">Full Name:</p>
                      <p className="font-semibold">
                        {stats.latestBlock.data.fullName || "N/A"}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-600">Country:</p>
                      <p className="font-semibold">
                        {stats.latestBlock.data.country || "N/A"}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-600">Action:</p>
                      <p className="font-semibold text-success-600">
                        {stats.latestBlock.data.action || "GENESIS"}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-green-50 border-l-4 border-green-500 p-4">
            ...
            <p className="text-sm text-green-700">
              Every tourist card is stored in an immutable blockchain. Any
              attempt to modify data will break the chain.
            </p>
          </div>
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4">
            ...
            <p className="text-sm text-blue-700">
              SHA-256 encryption ensures each block has a unique fingerprint
          ...
          <div className="bg-purple-50 border-l-4 border-purple-500 p-4">
            ...
            <p className="text-sm text-purple-700">
              Mining difficulty ensures computational work is required to add
              blocks, preventing spam attacks.
            </p>
          </div>
          ...
          <div className="bg-orange-50 border-l-4 border-orange-500 p-4">
            ...
            <p className="text-sm text-orange-700">
              Continuous validation ensures the entire blockchain integrity is
      ...
      <div className="text-center">
        <button onClick={fetchBlockchainStats} className="btn-primary">
